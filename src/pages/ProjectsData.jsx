...
export default function ProjectsData() {
    ...
    <div className="bg-[#0b0a08] min-h-screen text-[#e8e1d3]" dir="rtl">
      ...
      <section className="px-6 md:px-20 py-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* بطاقة الفئة */}
          <div className="group relative bg-[#111111] p-8 rounded-3xl border border-white/5 hover:border-orange-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/5 overflow-hidden">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-orange-500 text-xs uppercase font-extrabold tracking-widest">
                الفئة
              </h3>
            </div>
          ...
          {/* بطاقة الحالة */}
          <div className="group relative bg-[#111111] p-8 rounded-3xl border border-white/5 hover:border-green-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/5 overflow-hidden">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-green-400 text-xs uppercase font-extrabold tracking-widest">
                الحالة
              </h3>
            </div>
  ...
  <section className="px-6 md:px-20 py-20 border-t border-[#e8e1d3]/10">
   ...
   <section className="relative w-full py-28 px-6 md:px-16 overflow-hidden bg-[#070605] border-t border-white/[0.04]">
  <div className="relative z-10 max-w-4xl mx-auto text-center">
    
    {/* خط رفيع ناعم */}
    <div className="w-12 h-[1px] bg-orange-500/40 mx-auto mb-10" />

    {/* العنوان الهادئ والراقي */}
    <h2 className="text-3xl md:text-5xl font-light text-[#f6f1e7] tracking-tight mb-5 leading-snug">
      هل نال المشروع إعجابك؟
    </h2>

    {/* الوصف البسيط والمريح */}
    <p className="text-[#a39a87] text-base md:text-lg font-light max-w-xl mx-auto mb-10 leading-relaxed">
      تصفح بقية أعمالنا المصممة بعناية، أو تواصل معنا لنناقش فكرتك القادمة بهدوء واحترافية.
    </p>

    {/* الأزرار بتصميم Minimalist فخم */}
    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
      <button
        onClick={() => navigate("/smahan")}
        className="group inline-flex items-center gap-3 px-7 py-3.5 bg-white/[0.04] text-[#f6f1e7] font-normal text-sm tracking-wide rounded-full border border-white/10 hover:bg-orange-500 hover:text-black hover:border-orange-500 transition-all duration-300 cursor-pointer"
      >
        <span>عرض المزيد من المشاريع</span>
        <svg
          className="w-4 h-4 -rotate-45 group-hover:rotate-0 transition-transform duration-300 opacity-70 group-hover:opacity-100"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <button
        ...
        className="inline-flex items-center gap-2 px-7 py-3.5 text-[#a39a87] hover:text-[#f6f1e7] font-normal text-sm tracking-wide transition-colors duration-200 cursor-pointer"
      >
