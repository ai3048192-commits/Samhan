  ...
  return (
    <div className="bg-[#050505] min-h-screen w-full py-24 px-6" dir="rtl">
      <div className="max-w-7xl mx-auto">
        {/* تم التعديل هنا: التوسيط وإضافة تنسيق للعنوان */}
        ...
        {/* الشبكة تظل كما هي - هي متناسقة جداً */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((p) => (
            ...
            >
              {/* الصورة تأخذ الكرت كله وبدون أي تكبير */}
              <img
                src={p.image_url}
                alt={p.title}
              ...
              {/* التدرج اللوني فوق الصورة تماماً مثل الصورة */}
              ...
              {/* المحتوى في الأسفل (الاسم وزر استكشف تفاصيل المشروع) */}
